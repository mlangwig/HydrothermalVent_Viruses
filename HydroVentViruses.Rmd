...
for i in `cat mmseq_prot_names_novRhyme.txt`; do grep -w $i merged_KEGG_phrogs_viruses.txt >> mmseqs_KEGG_phrogs_annos.txt; done
```

For loop was slow so doing it this faster way:
```{bash, eval = FALSE}
