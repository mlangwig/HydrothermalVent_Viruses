...
cut -f1,2,5 ../PHROGs/convert_alis_evalparsed.tsv > convert_alis_80cov_75pi_eval_parse.tsv

sed 's/vRhyme_[0-9]__//g' convert_alis_80cov_75pi_eval_parse.tsv > convert_alis_80cov_75pi_eval_novRhyme.tsv
sed -i 's/vRhyme_[0-9][0-9]__//g' convert_alis_80cov_75pi_eval_novRhyme.tsv
sed -i 's/vRhyme_[0-9][0-9][0-9]__//g' convert_alis_80cov_75pi_eval_novRhyme.tsv
```
...
tail -n +2 convert_alis_80cov_75pi_eval_novRhyme.tsv | cat 52samples_KEGG_hmmtbl_parse2.tsv - > merged_KEGG_phrogs_viruses.txt
...
# Check mmseqs cluster with different annos
